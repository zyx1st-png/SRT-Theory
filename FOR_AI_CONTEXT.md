# For an AI: how to use this repository as context

You are being given one independent researcher's theoretical framework as context. Your task is not to decide whether it is true. Your task is to **understand it on its own terms**, and — when given a second framework or some external material — to **interpret that material through this model** and to **translate between this model and another**.
